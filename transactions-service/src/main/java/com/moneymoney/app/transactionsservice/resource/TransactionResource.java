...
public class TransactionResource {
	...
	public ResponseEntity<Transaction> fundTransfer(@RequestBody Transaction senderTansaction,
		...
		ResponseEntity<Double> senderEntity = restTemplate.getForEntity(
				"http://accounts-service/accounts/" + senderTansaction.getAccountNumber() + "/balance", Double.class);
		...
		restTemplate.put("http://accounts-service/accounts/" + senderTansaction.getAccountNumber() + "?currentBalance="
				+ updatedBalance[0], null);
		restTemplate.put("http://accounts-service/accounts/" + receiverTransaction.getAccountNumber() + "?currentBalance="
